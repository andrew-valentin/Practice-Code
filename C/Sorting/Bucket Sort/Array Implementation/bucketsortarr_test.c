...
int main()
{
	...
	bucketSortArr(arr1, len1);
	
	printf("Array after array bucket sort: ");
	printArr(arr1, len1);
	// [1, 2, 3, 5, 20, 21, 43, 45]
